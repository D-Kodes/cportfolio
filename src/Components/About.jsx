    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <br /><br /> 
          ...
          in integrating frontend and backend systems. I alao work on java and spring boot. 
          <br /><br />
          I have a strong foundation in computer science fundamentals, including data structures, algorithms,
          object-oriented design, and problem-solving. I have solved over 150 problems on LeetCode and GFG.
          <br /><br />
